...
export type PlaceDetailQuery = {
  place: Types.Maybe<{
    ...
    address: Types.Maybe<string>
    rating: Types.Maybe<{ value: Types.Maybe<number>; count: Types.Maybe<number> }>
  }>
}

export const PlaceDetailDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'PlaceDetail' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'googleId' } },
            ...
            arguments: [
              {
                ...
                value: { kind: 'Variable', name: { kind: 'Name', value: 'googleId' } }
              }
            ],
            selectionSet: {
              kind: 'SelectionSet',
