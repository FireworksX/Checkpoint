...
export type EditUserMutation = { editUser: { firstName: Types.Maybe<string>, lastName: Types.Maybe<string>, userName: Types.Maybe<string>, avatar: Types.Maybe<string>, bio: Types.Maybe<string> } };
